import numpy as np
from source.neural_network.__sigmoid__ import sigmoid, sigmoid_backward
from source.neural_network.__relu__ import relu, relu_backward
from source.neural_network.__tanh__ import tanh, tanh_backward
